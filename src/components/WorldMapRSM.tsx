          ...
          <Geographies geography={WORLD_TOPO}>
            {({ geographies }) =>
              geographies.map((geo) => {
                ...
                const country = iso3 ? INTL_PRICES_BY_ISO3[iso3] : null;
                const fill = country ? scale(country.pricePerPound) : "#1f1f23";
                return (
                  <Geography
                    key={geo.rsmKey}
                    geography={geo}
                    ...
                    style={{
                      ...
                      hover: { fill: country ? "#fff" : "#2a2a2e", outline: "none", stroke: "#71717a", strokeWidth: 0.8 },
